...
typedef struct {
	...
	uint8_t bumper_right : 1; // Boolean value for the right bumper
	uint8_t bumper_left : 1; // Boolean value for the left bumper
	uint8_t wheeldrop_right : 1; // Boolean value for the right wheel
	uint8_t wheeldrop_left : 1; // Boolean vale for the left wheel
